    ...
    return (
        <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-clinical-white">
            ...
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
                <div className="absolute top-[20%] left-[10%] w-72 h-72 bg-emerald/10 rounded-full blur-3xl animate-pulse" />
                <div className="absolute bottom-[20%] right-[10%] w-96 h-96 bg-navy-dark/5 rounded-full blur-3xl" />
            </div>
            ...
            <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative z-10 space-y-8">
                    ...
                    >
                        <span className="inline-block py-1 px-4 rounded-full bg-emerald/10 text-navy-dark text-xs font-bold tracking-wider uppercase mb-4">
                        ...
                        <h1 className="text-5xl md:text-6xl xl:text-7xl font-display font-bold text-navy-dark leading-[1.1]">
                            ...
                            <span className="text-emerald">Real-Time Monitoring</span>
                        </h1>
                    </motion.div>
                    ...
                    >
                        Transform your existing hospital monitors into smart, connected systems with our AI-powered plug-and-play retrofit device. We are actively bridging the gap between analog infrastructure and digital healthcare.
                    </motion.p>
                    ...
                    >
                        {stats.map((stat, i) => (
                            <div
                                key={i}
                                className="flex items-center gap-2 text-navy-dark/60 text-sm font-medium"
                            >
                ...
                >
                    <div className="relative z-10 rounded-3xl overflow-hidden shadow-2xl shadow-navy-dark/20 border border-navy-dark/10 transform rotate-1 hover:rotate-0 transition-transform duration-700">
                        <Image
                    ...
                    >
                        ...
                        <div className="flex flex-col">
                            <span className="text-xs text-navy-dark/50 font-bold uppercase">
                                Real-time Sync
                            </span>
                            <span className="text-sm font-mono font-bold text-navy-dark">
                                &lt; 500ms Latency
                            </span>
                        </div>
                    </motion.div>
