...
const vitals = [
    ...
    { id: "bp", name: "Blood Pressure", value: "120/80", unit: "mmHg", icon: Activity, color: "text-teal" },
            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="flex-1 w-full max-w-2xl">
                        <div className="relative aspect-video rounded-3xl overflow-hidden border-4 border-navy/10 shadow-2xl group cursor-pointer"
                            ...
                            <div className="absolute inset-0 bg-navy/20 backdrop-brightness-50 flex items-center justify-center">
                                {!isScanning && (
                                    <motion.div
                                        initial={{ opacity: 0 }}
                                        animate={{ opacity: 1 }}
                            ...
                            <AnimatePresence>
                                {isScanning && vitals.map((v, i) => (
                                    <motion.div
                                        ...
                                        className="absolute w-8 h-8 border-2 border-teal rounded-full flex items-center justify-center z-30"
                                        style={{
                                            top: `${20 + (i * 15)}%`,
                                            right: '20%'
                                        }}
                        ...
                        <p className="mt-6 text-center text-charcoal/50 text-sm font-medium">
                    ...
                    <div className="flex-1 space-y-10">
                        <div>
                            ...
                            <h3 className="text-4xl md:text-5xl font-display font-bold text-navy mb-6">
                                ...
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        detectedVitals.includes(vital.id)
                                            ? "bg-clinical-white border-teal shadow-lg shadow-teal/5"
                                            : "bg-soft-gray/30 border-soft-gray/50 opacity-40"
                                    )}
                                >
                                    <div className="flex items-center gap-3 mb-3">
                                        <vital.icon className={cn("w-5 h-5", vital.color)} />
                                        <span className="text-sm font-bold text-charcoal/60 uppercase tracking-wide">
                                            {vital.name}
                                        </span>
                                    </div>
                                    <div className="flex items-baseline gap-1">
                                        <span className="text-2xl font-mono font-bold text-navy">
                        ...
                        <div className="pt-6">
                            <div className="flex items-center gap-6 p-4 bg-navy/5 rounded-2xl border border-navy/10">
                                ...
                                <p className="text-xs font-medium text-charcoal/60">
                                    Trusted by <span className="text-navy font-bold">50+ Senior Clinicians</span> for data accuracy
                                </p>
                            </div>
                        </div>
                    </div>
