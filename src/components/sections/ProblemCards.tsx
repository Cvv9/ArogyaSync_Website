...
const problems = [
    {
        ...
        front: "Nurse spending hours on paper charts",
        back: "4+ hours/day wasted",
        solution: "Automated OCR in <100ms",
        description: "Our AI captures vitals directly from screens, eliminating human error.",
    },
    {
        icon: MonitorOff,
        title: "Outdated Systems",
        front: "Legacy monitors lack connectivity",
        back: "₹15-20L replacement cost",
        solution: "₹2.5L retrofit solution",
        description: "Extend life of existing equipment with smart edge connectivity.",
    },
    {
        icon: Users,
        title: "Overburdened Staff",
        front: "1:8 nurse-patient ratio",
        back: "High burnout & missed alerts",
        solution: "60% burden reduction",
        description: "Real-time alerts and remote monitoring for better care distribution.",
    },
    {
        icon: ShieldAlert,
        title: "Patient Safety",
        front: "43% of critical alerts delayed",
        back: "Delayed clinical response",
        solution: "2-hour earlier detection",
        description: "ML models predict complications before they become emergencies.",
    },
];
